$(document).ready(function(){
  ...
  var arr = [
                  "achievement","authority","competent","corroborate","deficiency",
                  "disapprove","emphasize","enlighten","influence","liaison",
                  "miraculous","necessity","permeate","predictable","questionnaire",
                  "rectangular","recurrent","rhythm","satisfaction","suspicious"
                ];
  var soal=[];
  var s=["dd"];
  var m=0;
